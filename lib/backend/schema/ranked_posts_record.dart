...
class RankedPostsRecord extends FirestoreRecord {
  RankedPostsRecord._(
  ...
  static Stream<RankedPostsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => RankedPostsRecord.fromSnapshot(s));

  static Future<RankedPostsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => RankedPostsRecord.fromSnapshot(s));

  static RankedPostsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      RankedPostsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static RankedPostsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      RankedPostsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'RankedPostsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is RankedPostsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createRankedPostsRecordData({
  String? postId,
  int? score,
  int? rank,
  String? category,
...
class RankedPostsRecordDocumentEquality implements Equality<RankedPostsRecord> {
  const RankedPostsRecordDocumentEquality();

  @override
  bool equals(RankedPostsRecord? e1, RankedPostsRecord? e2) {
  ...
  @override
  int hash(RankedPostsRecord? e) => const ListEquality().hash([
        e?.postId,
        e?.score,
        e?.rank,
        e?.category,
  ...
  @override
  bool isValidKey(Object? o) => o is RankedPostsRecord;
}
