...
class MessageDto {
  ...
  ///
  /// **⚠️ DEPRECATED**: Use MessageMapper.toEntity() instead
  /// - Migration: MessageDto.toDomain() → MessageMapper.toEntity(dto)
  /// - Location: lib/features/chat/data/mappers/message_mapper.dart
  @Deprecated('Use MessageMapper.toEntity() instead. Will be removed in v5.0')
  Message toDomain() {
    return Message(
      id: id,
      parentPath: parentPath,
  ...
  ///
  /// **⚠️ DEPRECATED**: Use MessageMapper.toDto() instead
  /// - Migration: MessageDto.fromDomain(entity) → MessageMapper.toDto(entity)
  /// - Location: lib/features/chat/data/mappers/message_mapper.dart
  @Deprecated('Use MessageMapper.toDto() instead. Will be removed in v5.0')
