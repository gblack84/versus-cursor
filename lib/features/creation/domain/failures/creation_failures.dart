...
/// 콘텐츠 생성 관련 실패
class CreateContentFailure extends Failure {
  const CreateContentFailure(String message, [String? code]) : super(message, code);
}
...
class CreationValidationFailure extends Failure {
