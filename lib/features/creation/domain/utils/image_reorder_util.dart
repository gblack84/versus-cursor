...
/// Pure utility functions for image reordering operations
/// 순수한 이미지 재정렬 유틸리티 함수들
///
/// Domain Layer utility - no external dependencies

/// Reorder images based on new ID order
/// Returns reordered data as a result object
ReorderResult reorderImages({
...
ReorderResult moveImageToPosition({
  required List<File> files,
  required List<double> aspectRatios,
