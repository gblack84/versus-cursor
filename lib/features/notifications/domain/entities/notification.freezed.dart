...
@JsonKey() final  bool hasVoted;
 ...
 final  String? body;
@JsonKey()@NotificationPriorityConverter() final  NotificationPriority notificationPriority;
...
@override @useResult
$Res call({
 String id, String userId, String type, String title, String content, DateTime createdAt, DateTime? readAt, bool isRead, DateTime? expiryTime, Map<String, dynamic> metadata, String postId, String postTitle, String postContent, String? postDescription, DateTime voteStartTime, DateTime voteEndTime, String? targetAudience, int? currentVotesA, int? currentVotesB, bool hasVoted, String? userVoteChoice, String? senderId, String? senderName, String? body,@NotificationPriorityConverter() NotificationPriority notificationPriority, List<String> imageUrlsA, List<String> imageUrlsB, double? aspectRatioA, double? aspectRatioB, String? layoutType
});
