...
extension VotingNotificationX on VotingNotification {
  ...
  bool get isDeadlineImminent {
    final timeLeft = voteEndTime.difference(DateTime.now());
  ...
  bool get hasMultipleImages {
    final countA = imageUrlsA.length;
    final countB = imageUrlsB.length;
  ...
  bool get shouldShowVoteCard {
    return imageUrlsA.isNotEmpty || imageUrlsB.isNotEmpty;
  }
}
