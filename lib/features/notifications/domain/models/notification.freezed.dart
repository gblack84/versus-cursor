...
@JsonKey() final  bool hasVoted;
 ...
 final  String? body;
@JsonKey(fromJson: NotificationPriority.fromJson, toJson: _notificationPriorityToJson) final  NotificationPriority notificationPriority;
