  ...
  Future<Result<void>> call(MarkAsReadParams params) async {
    try {
      ...
      if (params.userId.isEmpty || params.notificationId.isEmpty) {
        return const Result.failure('Invalid parameters: userId and notificationId are required');
      }
      ...
      if (notification.userId != params.userId) {
        return const Result.failure('Unauthorized: Cannot mark other user\'s notification as read');
      }
