...
class AppColors {
  ...
  static final Color errorRedOverlay = Colors.red.shade700.withValues(alpha: 0.9);
  
  // Success Colors
  static final Color successGreen = Colors.green.shade700;
  static final Color successGreenOverlay = Colors.green.shade700.withValues(alpha: 0.9);
