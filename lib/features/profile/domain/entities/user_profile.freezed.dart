...
@LatLngConverter() LatLng? get location; String? get country;// "South Korea" (정적, 프로필 식별)
 String? get countryCode;// "KR" (ISO 3166-1 alpha-2)
 String? get shortDescription; String? get gender; DateTime? get dateOfBirth; String? get language;// ============= System Timestamps =============
...
as LatLng?,country: freezed == country ? _self.country : country // ignore: cast_nullable_to_non_nullable
