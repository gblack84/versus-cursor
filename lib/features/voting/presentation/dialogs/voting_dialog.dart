...
class _VotingNotificationDialogState extends State<VotingNotificationDialog>
  ...
  Widget _buildVersusBoxes() {
    // B 옵션이 있는지 확인
    final bool hasBOption =
        widget.primaryImageUrlB != null || widget.optionB.isNotEmpty;
    ...
    if (effectiveSizeData == null &&
        (widget.aspectRatioA != null || widget.aspectRatioB != null)) {
      ...
      if (!hasBOption || hasOnlyTextB) {
        ...
        layoutType = AspectRatioAnalyzer.getOptimalLayout(
            widget.aspectRatioA, widget.aspectRatioB);
    ...
    if (effectiveSizeData != null) {
      ...
      boxesWidget = VotingBoxBuilder.buildBoxPair(
        context: context,
