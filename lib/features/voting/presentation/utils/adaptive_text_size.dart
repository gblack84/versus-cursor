...
class AdaptiveTextSize {
  ...
  static double _applyConstraints(double size, TextType textType) {
    ...
    switch (textType) {
      case TextType.title:
        minSize = VotingDialogConstraints.minTextSize + 2;
        maxSize = VotingDialogConstraints.maxTextSize + 4;
        break;
      case TextType.subtitle:
        minSize = VotingDialogConstraints.minTextSize + 1;
        maxSize = VotingDialogConstraints.maxTextSize + 2;
        break;
      case TextType.body:
        minSize = VotingDialogConstraints.minTextSize;
        maxSize = VotingDialogConstraints.maxTextSize;
        break;
      case TextType.caption:
        minSize = VotingDialogConstraints.minTextSize - 1;
        maxSize = VotingDialogConstraints.maxTextSize - 2;
      ...
      case TextType.label:
        minSize = VotingDialogConstraints.minTextSize;
        maxSize = VotingDialogConstraints.maxTextSize - 1;
        break;
      case TextType.button:
        minSize = VotingDialogConstraints.minTextSize + 1;
        maxSize = VotingDialogConstraints.maxTextSize + 1;
