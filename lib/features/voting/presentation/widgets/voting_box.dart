...
class VotingBox extends StatelessWidget {
  ...
  Widget _buildImageBackground() {
    ...
    return CachedNetworkImage(
      ...
      memCacheWidth: UnifiedImageCacheService.calculateMemCacheWidth(
          safeWidth), // 통합 캐시 서비스 사용
  ...
  double _getAdaptiveTextSize() {
    ...
    final textSize = VotingDialogConstraints.getAdaptiveTextSize(
      boxSize.height,
      baseTextSize: VotingDialogConstraints.defaultTextSize,
    );
  ...
  void _showImageViewer(BuildContext context) {
    ...
    VotingImageViewer.show(
      ...
      // 단일 이미지 호환성
      imageUrlA:
          effectiveImageUrlsA.isNotEmpty ? effectiveImageUrlsA.first : null,
      imageUrlB:
          effectiveImageUrlsB.isNotEmpty ? effectiveImageUrlsB.first : null,
      // 멀티이미지 지원
