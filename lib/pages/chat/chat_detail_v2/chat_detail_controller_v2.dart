...
class ChatDetailControllerV2 extends core.InMemoryChatController {
  ...
  @override
  Future<void> updateMessage(core.Message oldMessage, core.Message newMessage) async {
  ...
  @override
  Future<void> removeMessage(core.Message message, {bool animated = true}) async {
    final currentMessages = messages.toList();
