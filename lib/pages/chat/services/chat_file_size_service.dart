...
/// Service to calculate file sizes for chat media
class ChatFileSizeService {
  static final ChatFileSizeService _instance = ChatFileSizeService._internal();
  factory ChatFileSizeService() => _instance;
  ChatFileSizeService._internal();
