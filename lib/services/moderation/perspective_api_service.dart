...
class PerspectiveResult {
  ...
  factory PerspectiveResult.fromJson(Map<String, dynamic> json, String originalText) {
    ...
    bool isToxic = toxicity >= 0.7 || profanity >= 0.7 || threat >= 0.7 || insult >= 0.7;
  ...
  static List<ToxicSpan> _findToxicWords(String text, Map<String, double> scores) {
    ...
    final toxicPatterns = [
      ...
      // 영어 욕설
      RegExp(r'\b(fuck|shit|damn|bitch|asshole|stupid|idiot)\b', caseSensitive: false),
  ...
  static double _getScore(Map<String, dynamic> attributeScores, String attribute) {
    try {
      final attributeData = attributeScores[attribute] as Map<String, dynamic>?;
      if (attributeData == null) return 0.0;
      
      final summaryScores = attributeData['summaryScore'] as Map<String, dynamic>?;
