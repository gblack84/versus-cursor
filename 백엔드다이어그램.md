...
### 🚀 최근 추가 기능 (2025-07-20 ~ 2025-07-31)
...
### 🔧 주요 변경사항 (2025-07-31)
- **컬렉션 이름 정규화**: 모든 Firebase Functions에서 `_record` 접미사 제거
- **테스트 코드 정리**: 테스트 관련 파일 및 함수 완전 삭제
- **디렉토리 구조 개선**: config/, services/, functions/ 디렉토리 추가
- **Flutter 앱과 동기화**: 컬렉션 이름 완전 통일 (users, posts, notifications 등)